...
import { useCreateUserMutation, useGetAllUsersQuery, useGetUsersSizeQuery } from './api/usersApi'
...
export const Users: React.FC = () => {
  ...
  const users = useGetAllUsersQuery(toPayload(buildPage(pagination, sorting)))
